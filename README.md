...
<p align="center">
  <img src="./readme-assets/02-actions-top.png" alt="Node details panel listing five triggers and the nine Account actions" width="345">
  <img src="./readme-assets/03-actions-mid.png" alt="The same panel scrolled to the Backend, Circuit and Job actions" width="345">
</p>
<p align="center"><sub><b>Triggers (5)</b> and <b>Actions (34)</b> in one entry: the five job states on the left, then Account, Backend, Circuit and Job as you scroll. Session and Workload follow below.</sub></p>
...
Earlier releases shipped a separate **IBM Quantum Error Trigger** for this. It is hidden from the node panel from this release on, because the option above replaces it, but it remains installed and any workflow already using it keeps running unchanged.
